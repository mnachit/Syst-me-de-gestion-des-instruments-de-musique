            ...
            <div class="container px-4 px-lg-5 mt-5">
                <div class="d-flex justify-content-between">
                    ...
                    <h2 class="fw-bolder mb-4">
                        <a class="nav-link dropdown-toggle" id="navf" href="#" role="button" data-bs-toggle="dropdown" aria-expanded="false">Shop</a>
                        <ul class="dropdown-menu" aria-labelledby="navf">
                            <li><a value="1" class="dropdown-item" href="#!">All Product</a></li>
                            <li><hr class="dropdown-divider" /></li>
                            <li><a value="1" class="dropdown-item" href="#!">piano</a></li>
                            <li><hr class="dropdown-divider" /></li>
                            <li><a value="2" class="dropdown-item" href="#!">guitare</a></li>
                            <li><hr class="dropdown-divider" /></li>
                            <li><a value="3" class="dropdown-item" href="#!">le VIOLON</a></li>
                            <li><hr class="dropdown-divider" /></li>
                            <li><a value="4" class="dropdown-item" href="#!">Oud</a></li>
                            <li><hr class="dropdown-divider" /></li>
                            <li><a value="5" class="dropdown-item" href="#!">autre</a></li>
                        </ul>
                    </h2>
                    ...
                    <form action="script.php" method="POST" id="form-task44">
                        ...
                        <div class="modal-body">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="number" name="prix43" class="form-control" id="task-title_profil4" value='<?php echo $_SESSION['num_telee'];?>'/>
                                </div>
						</div>
                        <div class="modal-footer">
                            <a href="#" class="btn btn-white" data-bs-dismiss="modal">Cancel</a>
